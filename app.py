...
# =======================================================================
# 🌐 SISTEMA DE IDIOMAS MULTILENGUAJE CON FORMATO MEJORADO
# =======================================================================
...
alfa_css = st.session_state.filtro_oscuro / 100.0 if st.session_state.autenticado else 0.45

# Inyección CSS unificada con el formato exacto de "PLAYER"
st.markdown(f"""
    <style>
        ...
        /* Formato Unificado: Estilo de la palabra PLAYER de image_c8536e.png */
        h1, h2, h3, h4, .retro-text, .mario-title {{ 
            font-family: 'Press Start 2P', cursive !important; 
            line-height: 1.6; 
            text-align: center !important;
            color: #FBD000 !important; /* Amarillo oficial de PLAYER */
            text-shadow: 3px 3px 0px #000000, -1px -1px 0px #000000, 1px -1px 0px #000000, -1px 1px 0px #000000 !important;
            font-weight: bold !important;
        }}
        
        /* Ajuste de Tamaño para Títulos Principales Robustos */
        h1.login-main-title {{
            font-size: 28px !important;
            margin-bottom: 15px;
        }}
        h1.dashboard-main-title {{
        ...
        /* Botón START Centrado, Alargado y Más Grande */
        div.stButton > button {{
            background-color: #B2430A !important; color: #FFFFFF !important; font-family: 'Press Start 2P', cursive !important; font-size: 15px !important;
            border-radius: 6px !important; border: 4px solid #FCD116 !important; box-shadow: 5px 5px 0px #000000, inset 4px 4px 0px rgba(255,255,255,0.3) !important;
            padding: 16px 24px !important; width: 100% !important; min-height: 65px !important; transition: all 0.1s ease-in-out !important;
        }}
        div.stButton > button:hover {{ background-color: #FBD000 !important; color: #000000 !important; border-color: #FFFFFF !important; transform: scale(1.03); }}
        ...
        .fb-container {{ text-align: center; margin-top: 35px; padding: 12px; background-color: rgba(20, 24, 30, 0.85); border-radius: 8px; border: 3px solid #3b5998; }}
...
# =======================================================================
# 🔐 PANTALLA DE ACCESO (LOGIN CON ESTILO PLAYER UNIFICADO)
# =======================================================================
if not st.session_state.autenticado:
    ...
    # Título usando la clase login-main-title con el formato de PLAYER
    st.markdown(f"<h1 class='login-main-title'>{t['titulo_login']}</h1>", unsafe_allow_html=True)
    st.markdown(f"<h4 class='login-subtitle'>{t['sub_login']}</h4><br>", unsafe_allow_html=True)
    ...
    with col_l2:
        ...
        # Botón START extendido y con mayor padding
...
# Cabecera Interna Unificada al estilo de PLAYER
st.markdown(f"""
    <div class="header-container">
        <h1 class="dashboard-main-title">CONSORCIO SAN MIGUEL</h1>
        <div style="color:#FFFFFF; font-family:'Press Start 2P'; font-size:9px; margin-top:10px; line-height: 1.8; text-shadow: 2px 2px 0px #000;">
            <span style="color:#FBD000;">{t['player']}:</span> {display_name}<br>
            <span style="color:#43B047;">CARGO:</span> {display_cargo}
        </div>
    </div>
""", unsafe_allow_html=True)
